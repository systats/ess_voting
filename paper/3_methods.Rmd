...
All CHES party data is part of the clustering even though it could not be present in the ESS micro data. Clustering involves two dimensions and four indicators: 
...
The final cluster vector is attached to the data with name `cluster`.
